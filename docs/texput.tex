...
\maketitle
\section{}\label{motion-compensated-discrete-wavelet-transform-mcdwt}}
...
\href{https://en.wikipedia.org/wiki/Decorrelation}{decorrelated} in the
...
than the original pixels, and the information is represented by temporal
and spatial
...
\end{itemize}
    ...
    \hypertarget{video-scalability}{%
\subsection{\texorpdfstring{1. Video
\href{http://inst.eecs.berkeley.edu/~ee290t/sp04/lectures/videowavelet_UCB1-3.pdf}{scalability}}{1. Video scalability}}\label{video-scalability}}
...
the forward transform did).
    ...
    \hypertarget{wavelet-and-pyramid-domains}{%
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{def}\NormalTok{ sequence_2D_DWT(s, K):}
    \ControlFlowTok{for}\NormalTok{ image }\KeywordTok{in}\NormalTok{ s:}
\NormalTok{        _2D_DWT(image, K) }\CommentTok{# In-place computation}
    \ControlFlowTok{return}\NormalTok{ s}
    
\NormalTok{S }\OperatorTok{=}\NormalTok{ sequence_2D_DWT(s, K)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{def}\NormalTok{ sequence_2D_iDWT(S, K):}
    \ControlFlowTok{for}\NormalTok{ pyramid }\KeywordTok{in}\NormalTok{ S:}
\NormalTok{        _2D_iDWT(pyramid, K) }\CommentTok{# In-place computation}
    \ControlFlowTok{return}\NormalTok{ S}
    
\NormalTok{s }\OperatorTok{=}\NormalTok{ sequence_2D_iDWT(S, K)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{A.L, A.H }\OperatorTok{=}\NormalTok{ 2D_DWT(a)}
\NormalTok{B.L, B.H }\OperatorTok{=}\NormalTok{ 2D_DWT(b)}
\NormalTok{C.L, C.H }\OperatorTok{=}\NormalTok{ 2D_DWT(c)}
\NormalTok{[A.L] }\OperatorTok{=}\NormalTok{ 2D_iDWT(A.L,}\DecValTok{0}\NormalTok{) }\CommentTok{# Interpolate low-freqs}
\NormalTok{[A.H] }\OperatorTok{=}\NormalTok{ 2D_iDWT(}\DecValTok{0}\NormalTok{,A.H) }\CommentTok{# Interpolate high-freqs}
\NormalTok{[B.L] }\OperatorTok{=}\NormalTok{ 2D_iDWT(B.L,}\DecValTok{0}\NormalTok{)}
\NormalTok{[B.H] }\OperatorTok{=}\NormalTok{ 2D_iDWT(}\DecValTok{0}\NormalTok{,B.H)}
\NormalTok{[C.L] }\OperatorTok{=}\NormalTok{ 2D_iDWT(C.L,}\DecValTok{0}\NormalTok{)}
\NormalTok{[C.H] }\OperatorTok{=}\NormalTok{ 2D_iDWT(}\DecValTok{0}\NormalTok{,C.H)}
\NormalTok{[B.L]}\OperatorTok{->}\NormalTok{[A.L] }\OperatorTok{=}\NormalTok{ ME([B.L], [A.L]) }\CommentTok{# Motion estimation}
\NormalTok{[B_A.H] }\OperatorTok{=}\NormalTok{ MC([A.H], [B.L]}\OperatorTok{->}\NormalTok{[A.L]) }\CommentTok{# Project [A.H] using [B.L]->[A.L]}
\NormalTok{[B.L]}\OperatorTok{->}\NormalTok{[C.L] }\OperatorTok{=}\NormalTok{ ME([B.L], [C.L])}
\NormalTok{[B_C.H] }\OperatorTok{=}\NormalTok{ MC([C.H], [B.L]}\OperatorTok{->}\NormalTok{[C.L])}
\NormalTok{[}\OperatorTok{~}\NormalTok{B.H] }\OperatorTok{=}\NormalTok{ [B.H] }\OperatorTok{-}\NormalTok{ [B_A.H]}\OperatorTok{/}\DecValTok{2} \OperatorTok{+}\NormalTok{ [B_C.H]}\OperatorTok{/}\DecValTok{2}
\OperatorTok{~}\NormalTok{B.H }\OperatorTok{=}\NormalTok{ 2D_DWT([}\OperatorTok{~}\NormalTok{B.H])}
\NormalTok{A }\OperatorTok{=}\NormalTok{ A.L, A.H}
\NormalTok{B }\OperatorTok{=}\NormalTok{ B.L, }\OperatorTok{~}\NormalTok{B.H}
\NormalTok{C }\OperatorTok{=}\NormalTok{ C.L, C.H}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{analyze-the-input-images}{%
